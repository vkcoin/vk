...
const QString BITCOIN_IPC_PREFIX("Vickcurrency:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Vickcurrency: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Vickcurrency: click-to-pay handler");
    else
...
{
    // clicking on Vickcurrency: URLs creates FileOpen events on the Mac:
