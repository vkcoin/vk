...
public:
    ...
    {
        // Vickcurrency: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Vickcurrency: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Vickcurrency: two types of block: proof-of-work or proof-of-stake
    ...
    // Vickcurrency: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Vickcurrency: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Vickcurrency: block index flags
    enum  
    {
